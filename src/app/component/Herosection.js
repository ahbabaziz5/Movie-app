...
const Herosection = ({title}) => {
  return (
    <div className='border-2 w-full md:h-96 flex flex-col md:flex-row justify-between items-center bg-red-600' style={{ minHeight: 600 }}>
    <div className='h-auto md:w-1/2 font-serif md:ml-32 md:mr-4 text-center md:text-left'>
    ...
    <div className='h-auto md:w-1/2 font-serif md:ml-32'>
